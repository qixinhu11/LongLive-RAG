        ...
        if is_causal:
            if use_latentmem:
                self.model = CausalWanModelLatentMem.from_pretrained(
                    f"wan_models/{model_name}/", local_attn_size=local_attn_size, sink_size=sink_size, memory_size=memory_size)
            else:
        ...
        if kv_cache is not None:
            ...
            if clean_x is not None:
                ...
                if classify_mode:
                    ...
                    flow_pred = self.model(**flow_pred_kwargs).permute(0, 2, 1, 3, 4)
